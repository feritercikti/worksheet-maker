...
const MultipleChoice = ({ id, onUpdate }: MultipleChoiceProps) => {
  const { answers, updateAnswers, columnNumbers, updateColumnNumber } =
    ...
    <div className='w-full mb-5 bg-white'>
      ...
      {showPanel && (
        <div className='flex flex-col  py-3 gap-3'>
          ...
          <div className='mx-6 text-[14px]  gap-2 flex flex-col'>
